 ...
 * {@link CreateAvatar.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CreateAvatar#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CreateAvatar extends Fragment {
     ...
     * @return A new instance of fragment CreateAvatar.
     */
    // TODO: Rename and change types and number of parameters
    public static CreateAvatar newInstance(String param1, String param2) {
        CreateAvatar fragment = new CreateAvatar();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button updateAvatar = (Button) rootView.findViewById(R.id.btn_update_avatar_info);
        updateAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                print("update avatar with " + name + "age=" + age);


                Toast.makeText(getContext(), "Your game avatar is updated succesfully", Toast.LENGTH_SHORT).show();
